        ...
        <div className="bg-[#EEEEEE] pl-10 pr-4 lg:pr-10 py-11 overflow-hidden">
          <div className="overflow-scroll overflow-x-auto lg:w-[620px] h-[500px] border-black">
            ...
            <div className="text-[#666666] text-[16px] mr-2 lg:mr-4">
              ...
              is. Because <br /> add why not esteems amiable him. Interested the
              unaffected mrs law friendship add principles. Indeed on people do
              merits to. Court heard which up above <br /> hoped grave do.
              Answer living law things either sir bed length. Looked before{" "}
              <br /> we an on merely. <br />
